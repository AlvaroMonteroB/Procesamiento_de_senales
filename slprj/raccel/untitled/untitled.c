...
model_S ; void MdlInitialize ( void ) { rtDW . br1teobtjr = rtP .
Delay2_InitialCondition ; rtDW . gokb0v31yc [ 0 ] = rtP .
Delay_InitialCondition ; rtDW . gokb0v31yc [ 1 ] = rtP .
Delay_InitialCondition ; rtDW . gokb0v31yc [ 2 ] = rtP .
Delay_InitialCondition ; rtDW . gokb0v31yc [ 3 ] = rtP .
Delay_InitialCondition ; } void MdlStart ( void ) { { bool
externalInputIsInDatasetFormat = false ; void * pISigstreamManager =
rt_GetISigstreamManager ( rtS ) ;
rtwISigstreamManagerGetInputIsInDatasetFormat ( pISigstreamManager , &
externalInputIsInDatasetFormat ) ; if ( externalInputIsInDatasetFormat ) { }
} MdlInitialize ( ) ; } void MdlOutputs ( int_T tid ) { real_T temp ; if (
ssIsSampleHit ( rtS , 1 , 0 ) ) { rtB . dxmylpvgxj = rtDW . br1teobtjr * rtDW
. br1teobtjr ; rtB . gywoocbpcm = rtDW . gokb0v31yc [ 0 ] ; rtB . aikjqliogx
= rtB . dxmylpvgxj + rtP . Constant_Value ; } temp = rtP .
SignalGenerator_Frequency * ssGetT ( rtS ) ; if ( temp - muDoubleScalarFloor
( temp ) >= 0.5 ) { rtB . gkaikyhgeb = rtP . SignalGenerator_Amplitude ; }
else { rtB . gkaikyhgeb = - rtP . SignalGenerator_Amplitude ; } rtB .
eqqqm44coy = rtB . gkaikyhgeb * rtB . aikjqliogx ; UNUSED_PARAMETER ( tid ) ;
} void MdlOutputsTID2 ( int_T tid ) { UNUSED_PARAMETER ( tid ) ; } void
MdlUpdate ( int_T tid ) { if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { rtDW .
br1teobtjr = rtB . eqqqm44coy ; rtDW . gokb0v31yc [ 0U ] = rtDW . gokb0v31yc
[ 1U ] ; rtDW . gokb0v31yc [ 1U ] = rtDW . gokb0v31yc [ 2U ] ; rtDW .
gokb0v31yc [ 2U ] = rtDW . gokb0v31yc [ 3U ] ; rtDW . gokb0v31yc [ 3 ] = rtB
. gkaikyhgeb ; } UNUSED_PARAMETER ( tid ) ; } void MdlUpdateTID2 ( int_T tid
...
mr_untitled_restoreDataFromMxArray ( ( void * ) & ( rtDW . br1teobtjr ) ,
rtdwData , 0 , 0 , sizeof ( rtDW . br1teobtjr ) ) ;
mr_untitled_restoreDataFromMxArray ( ( void * ) & ( rtDW . gokb0v31yc ) ,
rtdwData , 0 , 1 , sizeof ( rtDW . gokb0v31yc ) ) ; } } mxArray *
...
ssSetNumBlocks ( rtS , 9 ) ; ssSetNumBlockIO ( rtS , 5 ) ;
ssSetNumBlockParams ( rtS , 5 ) ; } void MdlInitializeSampleTimes ( void ) {
ssSetSampleTime ( rtS , 0 , 0.0 ) ; ssSetSampleTime ( rtS , 1 ,
0.16666666666666666 ) ; ssSetOffsetTime ( rtS , 0 , 0.0 ) ; ssSetOffsetTime (
rtS , 1 , 0.0 ) ; } void raccel_set_checksum ( ) { ssSetChecksumVal ( rtS , 0
, 2736165599U ) ; ssSetChecksumVal ( rtS , 1 , 3351386178U ) ;
ssSetChecksumVal ( rtS , 2 , 3877766714U ) ; ssSetChecksumVal ( rtS , 3 ,
4054318713U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
const char_T * rt_LoggedStateBlockNames [ ] = { "untitled/Delay2" ,
"untitled/Delay" } ; static const char_T * rt_LoggedStateNames [ ] = {
...
rt_LoggedStateIdxList [ ] = { 0 , 1 } ; static RTWLogSignalInfo
...
) ; rt_LoggedStateSignalPtrs [ 0 ] = ( void * ) & rtDW . br1teobtjr ;
rt_LoggedStateSignalPtrs [ 1 ] = ( void * ) rtDW . gokb0v31yc ; } rtliSetLogT
...
ssSolverInfo slvrInfo ; ssSetStepSize ( rtS , 0.16666666666666666 ) ;
ssSetMinStepSize ( rtS , 0.0 ) ; ssSetMaxNumMinSteps ( rtS , - 1 ) ;
ssSetMinStepViolatedError ( rtS , 0 ) ; ssSetMaxStepSize ( rtS ,
0.16666666666666666 ) ; ssSetSolverMaxOrder ( rtS , - 1 ) ;
...
2736165599U ) ; ssSetChecksumVal ( rtS , 1 , 3351386178U ) ; ssSetChecksumVal
( rtS , 2 , 3877766714U ) ; ssSetChecksumVal ( rtS , 3 , 4054318713U ) ; {
