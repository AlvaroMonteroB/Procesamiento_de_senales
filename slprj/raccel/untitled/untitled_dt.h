...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . dxmylpvgxj ) , 0 , 0 , 5 } ,
{ ( char_T * ) ( & rtDW . br1teobtjr ) , 0 , 0 , 5 } , { ( char_T * ) ( &
rtDW . dwki4ltg1q . LoggedData ) , 11 , 0 , 2 } } ; static
DataTypeTransitionTable rtBTransTable = { 3U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
Delay2_InitialCondition ) , 0 , 0 , 5 } } ; static DataTypeTransitionTable
